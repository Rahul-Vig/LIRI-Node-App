...
if (command === "concert-this") {
  ...
  console.log(
    "For more accurate results search add the Artists name to your argument:"
  );
...
function concertThis(argument) {
  if (argument.length < 1) {
    return console.log(
      "No artist specified. Try again with the name of an artist."
    );
  }
  axios
    .get(
    ...
    .then(function(response) {
      console.log("Here are the upcoming events for " + argString);
      console.log("*********************************************************");
